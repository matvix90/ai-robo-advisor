...
class TestCalculatePerformanceMetrics:
    ...
    def test_calculate_metrics_custom_risk_free_rate(self, sample_price_series):
        ...
        metrics1 = calculate_performance_metrics(
            sample_price_series, risk_free_rate=0.02
        )
        metrics2 = calculate_performance_metrics(
            sample_price_series, risk_free_rate=0.05
        )
...
class TestCalculateRelativeMetrics:
    ...
    def test_calculate_relative_metrics_valid_data(
    ...
    def test_calculate_relative_metrics_beta_interpretation(self):
        ...
        high_beta_returns = benchmark_returns * 1.5 + pd.Series(
...
class TestAnalyzePortfolio:
    ...
    def test_analyze_portfolio_basic(self, sample_tickers_data, sample_ohlcv_data):
        ...
        result = analyze_portfolio(
            tickers_data=sample_tickers_data, benchmark_data=benchmark_data
        )
    ...
    def test_analyze_portfolio_with_weights(
        self, sample_tickers_data, sample_ohlcv_data
    ):
    ...
    def test_analyze_portfolio_equal_weights(
        self, sample_tickers_data, sample_ohlcv_data
    ):
    ...
    def test_analyze_portfolio_empty_tickers(self, sample_ohlcv_data):
        ...
        with pytest.raises(ValueError, match="tickers_data cannot be empty"):
            analyze_portfolio(tickers_data={}, benchmark_data=benchmark_data)
    ...
    def test_analyze_portfolio_empty_benchmark(self, sample_tickers_data):
        ...
        with pytest.raises(ValueError, match="benchmark_data cannot be empty"):
            analyze_portfolio(tickers_data=sample_tickers_data, benchmark_data=[])
    ...
    def test_analyze_portfolio_missing_close_column_ticker(self, sample_ohlcv_data):
        ...
        with pytest.raises(ValueError, match="Missing 'close' column"):
            analyze_portfolio(
                tickers_data=bad_ticker_data, benchmark_data=sample_ohlcv_data[:200]
            )

    def test_analyze_portfolio_missing_close_column_benchmark(
        ...
        with pytest.raises(ValueError, match="Missing 'close' column"):
            analyze_portfolio(
                tickers_data=sample_tickers_data, benchmark_data=bad_benchmark_data
            )

    def test_analyze_portfolio_custom_risk_free_rate(
        self, sample_tickers_data, sample_ohlcv_data
    ):
        ...
        assert (
            result1["portfolio"]["Sharpe Ratio"] != result2["portfolio"]["Sharpe Ratio"]
        )

    def test_analyze_portfolio_weights_normalization(
        self, sample_tickers_data, sample_ohlcv_data
    ):
    ...
    def test_analyze_portfolio_no_overlapping_data(self):
        ...
        with pytest.raises(ValueError):
            analyze_portfolio(tickers_data=ticker_data, benchmark_data=benchmark_data)
