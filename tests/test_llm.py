...
class TestLLMModel:
    ...
    def test_llm_model_validation(self):
        ...
        with pytest.raises(ValidationError):
            LLMModel(provider="invalid_provider", model_name="test", display="Test")
...
class TestGetLLMModel:
    ...
    def test_get_anthropic_model(self, mock_config, mock_init_chat):
        ...
        result = get_llm_model(ModelProvider.ANTHROPIC, "claude-3-5-sonnet-latest")
    ...
    def test_get_openai_model(self, mock_config, mock_init_chat):
        ...
        result = get_llm_model(ModelProvider.OPENAI, "gpt-4o")
    ...
    def test_get_google_model(self, mock_config, mock_init_chat):
        ...
        result = get_llm_model(ModelProvider.GOOGLE, "gemini-2.0-flash")
    ...
    def test_get_model_with_custom_api_key(self, mock_config, mock_init_chat):
        ...
        result = get_llm_model(
            ModelProvider.ANTHROPIC, "claude-3-5-sonnet-latest", api_key="custom-key"
        )
