...
from src.data.models import AnalysisAgent, AnalysisResponse, RiskProfile, Status
...
class TestIsApprovedNode:
    ...
    def test_is_approved_one_pass_rejected(self, sample_state_with_portfolio, mock_llm):
        ...
        sample_state_with_portfolio["data"]["investment"][
            "user_preferences"
    ...
    def test_is_approved_collects_all_advices(
        ...
        sample_state_with_portfolio["data"]["analysis"] = {
            ...
            "diversification": AnalysisAgent(
                ...
                reasoning="Poor diversification",
                advices=[
                    "Advice from diversification 1",
                    "Advice from diversification 2",
                ],
            ),
            "alignment": AnalysisAgent(
                status=Status(key="is_aligned", value=False),
    ...
    def test_is_approved_llm_prompt_structure(
        self, sample_state_with_portfolio, mock_llm
    ):
...
class TestCreateAnalystGraph:
    ...
    def test_create_analyst_graph_nodes_integrated(
        self,
        mock_perf,
        mock_align,
        mock_div,
...
class TestAnalystWorkflowIntegration:
    ...
    def test_analyst_workflow_end_to_end_approved(
        self, sample_state_with_portfolio, mock_llm
    ):
    ...
    def test_analyst_workflow_end_to_end_rejected(
        self, sample_state_with_portfolio, mock_llm
    ):
