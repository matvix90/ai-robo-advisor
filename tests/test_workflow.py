...
from src.main import create_workflow, run_workflow, start
...
class TestRunWorkflow:
    ...
    def test_run_workflow_basic(
        self, mock_create_workflow, sample_portfolio_preference, mock_llm
    ):
    ...
    @patch("src.main.create_workflow")
    def test_run_workflow_with_reasoning(
        self, mock_create_workflow, sample_portfolio_preference, mock_llm
    ):
    ...
    @patch("src.main.create_workflow")
    def test_run_workflow_with_analyst(
        self, mock_create_workflow, sample_portfolio_preference, mock_llm
    ):
        ...
        mock_result = {
            "data": {
                "investment": {"strategy": Mock(), "analyst": "Warren Buffett"},
                "portfolio": Mock(strategy=Mock()),
                "analysis": {"summary": Mock()},
            },
            "metadata": {"show_reasoning": False},
...
class TestWorkflowIntegration:
    ...
    def test_workflow_node_execution_order(
        self, mock_create_portfolio, mock_investment_strategy, sample_state
    ):
...
class TestMainFunction:
    ...
    def test_main_success(
        ...
        mock_result = {
            "data": {"portfolio": sample_portfolio, "analysis": {"summary": Mock()}}
        }
    ...
    def test_main_with_show_reasoning_flag(
        self,
        mock_print_analysis,
        mock_print_portfolio,
        mock_print_strategy,
