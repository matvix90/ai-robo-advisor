"""Utility functions for creating investor profiles and formatting user preferences."""


def create_investor_profile(portfolio_preferences) -> str:
    """
    Create a formatted investor profile string from portfolio preferences.
    
    This function extracts and formats user investment preferences into a 
    comprehensive prompt string that can be used by the investment strategy agent.
    
    Args:
        portfolio_preferences: Object containing user's investment preferences
        
    Returns:
        str: Formatted profile string with all user preferences
    """
    profile = f"""Create a comprehensive investment strategy based on the following user preferences:
